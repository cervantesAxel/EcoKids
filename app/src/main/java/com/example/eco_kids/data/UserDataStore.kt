...
class UserDataStore (private val context: Context){
    ...
    companion object {
        ...
        val USER_PET_KEY = stringPreferencesKey("user_pet")
    }
    ...
    val userPet: Flow<String?> = context.userDataStore.data
        .map{ preferences ->
            preferences[USER_PET_KEY]
        }

    suspend fun saveUser (name: String, pet: String){
